...
public class Heisenberg extends JPanel {
    ...
    public Heisenberg(Dimension size) {
        ...
        heisenbergEx = new JLabel("<html>  --The Heisenberg uncertainty principle states that it is impossible to determine simutaneously both the position and velocity of an electron or any other particle. This is because in order to find the most likely place of an electron, scientists combine multiple waves together. The highest crest formed by these waves is the most probable location of the electron. However, since there are so many different waves to choose from, scientists cannot pick out any single velocity. If there is only one wave, it is hard to discern where the electron might be, but easy to find what the momentum of the electron is. </html>", SwingConstants.LEFT);
